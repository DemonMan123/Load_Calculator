...
class NavPanel(customtkinter.CTkFrame):
    def __init__(self, master,
        ...
        self.StartupChklstButton = customtkinter.CTkButton(self, text="Startup checklist",command=on_startup_click)
        self.StartupChklstButton.grid(row=2, column=0, padx=10, pady=10, sticky="w")
